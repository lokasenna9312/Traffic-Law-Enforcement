  ...
  public partial class EnforcementSaveDataSystem : GameSystemBase,
    ...
    private readonly struct PolicyImpactPersistentTotalsReadResult {
      ...
      public PolicyImpactPersistentTotalsReadResult(
          ...
          int publicTransportLaneActualCount, int midBlockCrossingActualCount,
          int intersectionMovementActualCount,
          int publicTransportLaneFineAmount, int midBlockCrossingFineAmount,
    ...
    ReadMonthlyEnforcementTrackingState<TReader>(TReader reader, int version)
        where TReader : IReader {
      bool migratedLegacyPathRequestTracking = version < 4;

      reader.Read(out bool hasTrackingState);
      if (!hasTrackingState) {
        return new MonthlyTrackingReadResult(null,
      ...
      return new MonthlyTrackingReadResult(trackingState,
                                           migratedLegacyPathRequestTracking);
    }
    ...
    ReadMonthlyEnforcementReports<TReader>(TReader reader, int version)
      ...
      for (int index = 0; index < reportCount; index += 1) {
        ...
        reports.Add(new MonthlyEnforcementReport(
            monthIndex, reportTotalPathRequestCount, reportTotalActualPathCount,
            publicTransportLaneCount, midBlockCrossingCount,
            intersectionMovementCount, reportFineAmount,
            reportTotalAvoidedPathCount, reportPublicTransportLaneFineAmount,
    ...
    private static EnforcementPolicyImpactTrackingState? ReadPolicyImpactTrackingState<
      ...
      if (version < 8) {
        trackingTotalActualPathCount = trackingPublicTransportLaneActualCount +
                                       trackingMidBlockCrossingActualCount +
                                       trackingIntersectionMovementActualCount;
      }
      ...
      EnforcementPolicyImpactTrackingState trackingState =
          new EnforcementPolicyImpactTrackingState(
              ...
              trackingTotalActualPathCount, trackingTotalAvoidedPathCount,
              trackingTotalFineAmount, trackingPublicTransportLaneActualCount,
              trackingMidBlockCrossingActualCount,
              trackingIntersectionMovementActualCount,
              trackingPublicTransportLaneFineAmount,
              trackingMidBlockCrossingFineAmount,
    ...
    ReadPolicyImpactPersistentTotals<TReader>(TReader reader, int version)
      ...
      return new PolicyImpactPersistentTotalsReadResult(
          totalPathRequestCount, totalActualPathCount, totalAvoidedPathCount,
          totalPolicyImpactFineAmount, publicTransportLaneActualCount,
          midBlockCrossingActualCount, intersectionMovementActualCount,
          publicTransportLaneFineAmount, midBlockCrossingFineAmount,
          intersectionMovementFineAmount, publicTransportLaneAvoidedEventCount,
          midBlockCrossingAvoidedEventCount,
          intersectionMovementAvoidedEventCount, totalActualOrAvoidedPathCount,
          publicTransportLaneActualOrAvoidedPathCount,
          midBlockCrossingActualOrAvoidedPathCount,
          intersectionMovementActualOrAvoidedPathCount);
    }

    private static PolicyImpactEventsReadResult ReadPolicyImpactEvents<TReader>(
      ...
      if (version >= 5) {
        ...
        for (int index = 0; index < pathRequestEventCount; index += 1) {
          ...
          pathRequestEvents.Add(
              new PathRequestEvent(timestampMonthTicks, pathContextSequence));
        }
        ...
        for (int index = 0; index < actualViolationEventCount; index += 1) {
          ...
          actualViolationEvents.Add(new ActualViolationEvent(
              timestampMonthTicks, pathContextSequence, kind, fineAmount));
        }
        ...
        for (int index = 0; index < avoidedRerouteEventCount; index += 1) {
          ...
          avoidedRerouteEvents.Add(new AvoidedRerouteEvent(
              ...
              avoidedPublicTransportLanePenalty, avoidedMidBlockPenalty,
    ...
    protected override void OnCreate() {
      ...
      m_PublicTransportLaneProfileQuery =
          GetEntityQuery(ComponentType.ReadOnly<Car>(),
    ...
    public void Serialize<TWriter>(TWriter writer)
      ...
      foreach (KeyValuePair<int, (int violationCount, int fineTotal)> pair in
                   vehiclePenaltySnapshot) {
      ...
      IReadOnlyCollection<(string kind, int vehicleId,
                           long timestampMonthTicks)> violationTimestamps =
      ...
      WritePolicyImpactEvents(writer, pathRequestEvents, actualViolationEvents,
    ...
    public void Deserialize<TReader>(TReader reader)
      ...
      for (int index = 0; index < recordCount; index += 1) {
        ...
        records.Add(
            new EnforcementRecord(kind, vehicleId, laneId, fineAmount, reason));
      }

      List<(string kind, int vehicleId, long timestampMonthTicks)> timestamps =
      ...
      for (int index = 0; index < fineIncomeCount; index += 1) {
        ...
        reader.Read(out string kind);
        fineIncomeEvents.Add(new EnforcementBudgetUIService.FineIncomeEvent(
      ...
      EnforcementPolicyImpactTrackingState? policyImpactTrackingState =
          ReadPolicyImpactTrackingState(reader, version,
                                        migratedLegacyPathRequestTracking);
      ...
      EnforcementPolicyImpactService.LoadPersistentData(
          policyImpactTrackingState, totalsReadResult.TotalPathRequestCount,
    ...
    private void ApplyLoadedStateToWorld() {
      ...
      if (!m_HasDeserializedData && m_ShouldClearLegacyRuntimeState) {
        ...
        if (!m_PublicTransportLanePermissionStateQuery.IsEmptyIgnoreFilter) {
          EntityManager.RemoveComponent<PublicTransportLanePermissionState>(
      ...
      for (int index = 0;
           index < m_LoadedPublicTransportLaneVehicleStates.Count; index += 1) {
    ...
    private static void WriteMonthlyEnforcementReports<TWriter>(
        TWriter writer, IReadOnlyCollection<MonthlyEnforcementReport> reports)
        where TWriter : IWriter {
    ...
    private static void WritePolicyImpactEvents<TWriter>(
        TWriter writer, IReadOnlyCollection<PathRequestEvent> pathRequestEvents,
        IReadOnlyCollection<ActualViolationEvent> actualViolationEvents,
        IReadOnlyCollection<AvoidedRerouteEvent> avoidedRerouteEvents)
        where TWriter : IWriter {
    ...
    private void WriteLoadedPublicTransportLaneVehicleStates<TWriter>(
      ...
      NativeArray<VehicleTrafficLawProfile> ptProfiles =
          m_PublicTransportLaneProfileQuery
              .ToComponentDataArray<VehicleTrafficLawProfile>(Allocator.Temp);
    ...
    private static void WritePolicyImpactTrackingState<TWriter>(TWriter writer)
      ...
      writer.Write(
          policyImpactTrackingState.m_PublicTransportLaneAvoidedEventCount);
      writer.Write(
          policyImpactTrackingState.m_MidBlockCrossingAvoidedEventCount);
      writer.Write(
          policyImpactTrackingState.m_IntersectionMovementAvoidedEventCount);
      ...
      writer.Write(
          policyImpactTrackingState.m_MidBlockCrossingActualOrAvoidedPathCount);
      writer.Write(policyImpactTrackingState
    ...
    ReadGameplaySettings<TReader>(TReader reader, int version)
      ...
      // PublicTransportLane fields (for older saves) (Assume the reader will
      // provide the correct order; if not, add explicit field mapping here)
