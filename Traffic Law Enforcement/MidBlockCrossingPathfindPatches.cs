...
{
    internal static class MidBlockCrossingPathfindPatches
    {
        private const string HarmonyId =
            "Traffic_Law_Enforcement.MidBlockCrossingPathfindPatches";
            ...
            MethodBase __originalMethod)
        {
            ...
            if (EnforcementLoggingPolicy.ShouldLogEnforcementEvents())
            {
                Mod.log.Info(
                    ...
                    $"reason={reasonCode}, moneyWeight={moneyWeight:0.###}, " +
                    $"addedCost={penalty * moneyWeight:0.###}");
            }
        }
